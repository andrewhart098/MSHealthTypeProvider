...
namespace MSHealth.Tests
{
    ...
    public class ParsingTests
    {
        ...
        public void CanParseDevices()
        {
            ...
            Assert.AreEqual(dev.DeviceProfiles.First().CreatedDate.Date, DateTime.Parse("2015-12-08T16:58:59.585Z").Date);
            Assert.AreEqual(dev.DeviceProfiles.First().Id, "string");
            Assert.AreEqual(dev.DeviceProfiles.First().HardwareVersion, "string");
        }
